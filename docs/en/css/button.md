...
Set class `is-{variant}` to implement different button variants.

<div class="flex gap-4 flex-wrap">
    <button class="j-button is-default">Default Button</button>
    <button class="j-button is-primary">Primary Button</button>
    <button class="j-button is-secondary">Secondary Button</button>
    <button class="j-button is-outline">Outline Button</button>
    <button class="j-button is-ghost">Ghost Button</button>
    <button class="j-button is-text">Text Button</button>
    <button class="j-button is-danger">Danger Button</button>
    <button class="j-button is-warning">Warning Button</button>
    <button class="j-button is-success">Success Button</button>
</div>
...
<div class="flex gap-4 flex-wrap">
    <button class="j-button is-default" disabled="">Default Button</button>
    <button class="j-button is-primary" disabled="">Primary Button</button>
    <button class="j-button is-secondary" disabled="">Secondary Button</button>
    <button class="j-button is-outline" disabled="">Outline Button</button>
    <button class="j-button is-ghost" disabled="">Ghost Button</button>
    <button class="j-button is-text" disabled="">Text Button</button>
    <button class="j-button is-danger" disabled="">Danger Button</button>
    <button class="j-button is-warning" disabled="">Warning Button</button>
    <button class="j-button is-success" disabled="">Success Button</button>
</div>
...
Set class `is-icon` to implement icon buttons.
...
```html
<button class="j-button is-default is-icon">
    <span class="el-icon"> {Icon Element} </span>
</button>
```

## Different Sizes

Set class `is-{size}` to implement buttons of different sizes.

<div class="flex gap-4 flex-wrap">
    <button class="j-button is-outline is-sm">Small Button</button>
    <button class="j-button is-outline is-md">Medium Button</button>
    <button class="j-button is-outline is-lg">Large Button</button>
</div>
...
Set container class `j-button-group` to implement button groups.
...
1. `el-{element}`: Supports: prefix element `prefix`, suffix element `suffix`, icon element `icon`, use as needed.
2. When there is no `prefix` / `suffix`, the `button-content` element can be omitted.

## Side Note

Contextual Application Comparison
